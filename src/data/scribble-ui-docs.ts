...
<ScribbleButton variant="primary">
  ...
  },
  {
    ...
    name: "ScribbleCard",
    title: "Card",
    description: "Container with sketchy hand-drawn border, optional overlay patterns, and tape decoration. Includes header, content, and footer sub-components.",
    category: "core",
    variants: [
    ...
    props: [
      ...
      { name: "overlayColor", type: "string", default: '"rgba(200, 200, 200, 0.1)"', description: "Overlay pattern color (semi-transparent)" },
      { name: "overlayHachureAngle", type: "number", default: "45", description: "Angle for hachure/zigzag patterns" },
      { name: "overlayHachureGap", type: "number", default: "10", description: "Gap between pattern lines" },
      ...
      { name: "shadow", type: '"none" | "sm" | "md" | "lg"', default: '"none"', description: "Shadow style" },
